                ...
                <div class="swiper index-main-slide">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img src="/images/mainbanner.jpg" alt="" class="bg-img pc">
                            <img src="/images/mainbanner.jpg" alt="" class="bg-img mb">
                            <div class="txt-box pc">
                                <p class="sub-title">
                                    (PC)디지털 트랜스포메이션(DX) 핵심기술을 활용한 스마트 사양관리
                                </p>
                                <h2 class="title">
                                    축산에 가치를 더하는 기업 NOVA
                                </h2>
                            ...
                            <div class="txt-box mb">
                                <p class="sub-title">
                                    (MB)디지털 트랜스포메이션(DX) 핵심기술을 활용한 스마트 사양관리
                                </p>
                                <h2 class="title">
                                    축산에 가치를 더하는 기업 NOVA
                                </h2>
