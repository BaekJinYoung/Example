<div class="header-wrap col-group">
    ...
    <div class="translate-btn-wrap col-group">
        <a href="{{ route('client.lang.ko') }}" class="translate-btn {{ session('locale', 'ko') == 'ko' ? 'active' : '' }}">
            KOR
        </a>
        <a href="{{ route('client.lang.en') }}" class="translate-btn {{ session('locale', 'ko') == 'en' ? 'active' : '' }}">
            ENG
        </a>
    </div>
