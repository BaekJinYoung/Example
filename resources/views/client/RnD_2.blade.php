                    ...
                    <div class="thesis-list row-group">
                        <div class="thesis-item">
                            <div class="thesis-title-wrap col-group">
                                <p class="thesis-title">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
    Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
                                <i class="xi-angle-down thesis-more-btn"></i>
                            </div>
                            <div class="thesis-detail-wrap">
                                <p class="thesis-txt">ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
