        ...
        <div class="subpage-wrap">
            <div class="section container w1440">
                ...
                <div class="greeting-txt">
                    The livestock industry is facing several challenges, but also new opportunities. To overcome these
                    challenges, NOVA provides innovative solutions. <br>
                    We redefine the future of livestock farming by utilizing digital transformation (DX) technologies
                    such as artificial intelligence, cloud computing, and digital twins.<br>
                    Our smart livestock technology automates farm operations and provides a sustainable alternative to
                    labor shortage and an aging workforce. <br>
                    We monitor livestock health and growth in real time using advanced camera systems and data analysis,
                    allowing farm owners to manage more efficiently and effectively.<br>
                    <br>
                    Our goal is not only to automate livestock farming,<br>
                    but also to maximize feed efficiency, optimize shipment timing, and improve animal welfare through
                    disease prevention.<br>
                    Our technology helps farm owners save time and resources, increase productivity, and achieve
                    sustainable livestock farming.<br>
                    <br>
                    At NOVA, we are confident that the change is already a reality. <br>
                    We will continue to join you on the journey towards sustainable and intelligent livestock
                    farming.<br>
