                ...
                <div class="container w1440">
                    ...
                    <div class="sub-section">
                        <div class="subpage-title-wrap center sub row-group">
                            ...
                            <p class="txt">
                                ...
                                The NOVA VISION camera, with stereo vision technology, accurately measures the 3D body
                                shape of livestock.
                            </p>
                        </div>
                    ...
                    <div class="sub-section">
                        <div class="subpage-title-wrap center sub row-group">
                            ...
                            <div class="txt-group row-group">
                                <p class="txt">
                                    <i class="xi-check-circle-o icon"></i>
                                    A deep learning model is trained on 3D body shapes of livestock for weight
                                    prediction.Weight Prediction Results
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="sub-section">
                        <div class="subpage-title-wrap center sub row-group">
                            ...
                            <p class="txt">
                                <i class="xi-check-circle-o icon"></i>
                                Farm owners can monitor the growth of livestock in real-time and precisely manage their
                                farms.
                            </p>
                        </div>
